  ...
  return (
    <div>
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Diário de Trading EXLs</h1>
        <p className="text-gray-400">
          Registre e acompanhe suas operações diárias
        </p>
      </div>
      ...
      <nav className="flex justify-center gap-5 mb-8">
        <Button
          ...
          className={`px-5 py-2.5 font-bold rounded ${
            activeTab === "calendar"
              ? "bg-[#BBF717] text-[#0E0E0E]"
              : "bg-[#1C1C1C] text-[#BBF717] hover:bg-[#2C2C2C]"
          }`}
        >
          Calendário
        </Button>
